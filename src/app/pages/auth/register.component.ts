  ...
  template: `
    <div class="register-container">
      <mat-card class="register-card">
        <mat-card-header>
          <mat-card-title>Register for Citizen Sphere</mat-card-title>
        </mat-card-header>
        <mat-card-content>
          <form (ngSubmit)="onRegister()">
            ...
            <mat-form-field class="full-width">
              ...
              <mat-select [(ngModel)]="selectedRole" name="role" required>
                ...
                <mat-option [value]="UserRole.DepartmentHead"
                  >Department Head</mat-option
                >
              </mat-select>
            </mat-form-field>

            <mat-form-field
              *ngIf="selectedRole !== UserRole.Citizen"
              class="full-width"
            >
...
export class RegisterComponent {
  ...
  onRegister() {
    ...
    const registerRequest: RegisterRequest = {
      ...
      department:
        this.selectedRole !== UserRole.Citizen ? this.department : undefined,
